...
class TestCycleFinder(TestCase):
	def test_single_cycle(self):
		...
		self.assertEqual(find_all_connected(graph), [['ASU', 'Oregon', 'Colorado', 'U$C', 'Utah', 'Cal']])
	...
	def test_multiple_cycles(self):
		...
		self.assertEqual(find_all_connected(graph), [['Colorado', 'U$C', 'Stanfurd'], ['Oregon', 'Cal', 'ASU']])
